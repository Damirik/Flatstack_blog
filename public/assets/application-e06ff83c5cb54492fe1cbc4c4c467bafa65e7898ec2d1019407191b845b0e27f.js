...
(function() {
  $(function() {
    return $(document).on("ajax:complete", "[data-behavior=\"fragments\"]", function(e, xhr) {
      var $fragments, $response;
      $response = $(xhr.responseText);
      $fragments = $response.findAndFilter("[data-fragment-id]");
      return $fragments.each(function(i, element) {
        var $element, $fragmentContainer, $newContent, $oldContent, fragmentId, fragmentSelector;
        $element = $(element);
        ...
        $fragmentContainer.html($newContent).trigger("fragment:update", [$newContent, $oldContent, xhr]);
        return $("body")[0].className += '';
      });
    });
  });
